...
developer tools for chrome: 1> launch chrome
                            2> go to options ( top rhs side )
                            3> select more tools
                            4> go to developer tools
                            
Under developer tools you will find the folowing:

console: It displays the resultant output.
source: It mentions the source files thoroughly with the internal code. 
